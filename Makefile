...
db/migrations/goto: confirm
	...
	./migrate -path ./migrations -database "postgres://greenlight:password@localhost/greenlight?sslmode=disable" goto ${version}

## db/migrations/force version=$1: force database migration
.PHONY: db/migrations/force
db/migrations/force: confirm
	@echo 'Forcing database migration to version ${version}...'
	./migrate -path ./migrations -database "postgres://greenlight:password@localhost/greenlight?sslmode=disable" force ${version}

## db/migrations/version: print the current in-use migration version
.PHONY: db/migrations/version
db/migrations/version:
	@echo 'Version:'
	./migrate -path ./migrations -database "postgres://greenlight:password@localhost/greenlight?sslmode=disable" version
